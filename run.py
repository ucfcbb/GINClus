...
# from tensorflow.keras.models import Model as Modell
...
def main():
    ...
    create_required_directories(partial_pdbx_dir, output_dir)
    ...
    f = open("families.pickle","wb")
    pickle.dump(families, f)
    f.close()

    generate_graphs_for_loops(families, partial_pdbx_dir, output_dir, use_loop_name_in_graph_fname)
...
def generate_graphs_for_loops(families, partial_pdbx_dir, output_dir, use_loop_name_in_graph_fname=False):
    graph_list = []
    ...
    output_to_file_v2(graph_list, output_dir, use_loop_name_in_graph_fname)
    # global dataset
...
def output_to_file_v2(graph_list, graph_dir, use_loop_name_in_graph_fname):

    f = open("families.pickle", 'rb')
