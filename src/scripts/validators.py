...
def is_valid_pickle(pickle_fname, clusters, alignment_tool):

    if os.path.basename(pickle_fname).startswith(alignment_tool.lower() + '_alignment'):
    ...
    elif os.path.basename(pickle_fname).startswith(alignment_tool.lower() + '_rmsd'):
