...
partial_pdbx_dir = 'data/pdbx_extracted_ext0/'
...
def generate_pymol_images(scl_wise_loop_dict, pdb_ind_list_dict, image_output_dir):
...
def main():
    input_fname = 'Subcluster_output.csv'
    ...
    for line in lines[1:]:
        ...
        scl_wise_loop_dict[scl_id].append((loop, pieces[0].strip()))
    ...
    generate_pymol_images(scl_wise_loop_dict, pdb_ind_list_dict, 'subcluster_images')
