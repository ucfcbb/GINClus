...
*** The GINClus clustering results for [internal loops](output/Subcluster_output_IL_PDB.xlsx) and [hairpin loops](output/Subcluster_output_HL_PDB.xlsx) discussed in the paper are provided inside folder [output](output/). The Q-score output for [internal loops](output/Subcluster_output_qscore_HL.xlsx) and [hairpin loops](output/Subcluster_output_qscore_HL.xlsx) is provided inside folder [output](output/).  
*** The GINClus clustering results for NRList release 3.364 of [internal loops](output/NRList_3.364_output/Subcluster_output_IL_NRList_3.364.xlsx) and [hairpin loops](output/NRList_3.364_output/Subcluster_output_HL_NRList_3.364.xlsx) discussed in the paper are provided inside folder [output/NRList_3.364_output](output/NRList_3.364_output).  
