...
**_Run command:_** python3 run.py [-i1 'Train_motif_location_IL_PDB_input.csv'] [-i2 'Unknown_motif_location_IL_PDB_input.csv'] [-o 'output/'] [-e 0] [-d web] [-idt pdb] [-t True] [-idx 0] [-w 1] [-val 0.064] [-test 0.063] [-f True] [-c True] [-k 400] [-s False] [-kmin 200] [-kmax 400] [-kinc 50] [-p False]  
...
The input files IL_loops_PDB_3.364.csv and HL_loops_PDB_3.364.csv for NRList release 3.364 run is provided inside folder [data](data/). The clustering output for NRList release 3.364 is provided inside folder [output](output/). For internal loops, the output files are Subcluster_output_IL_PDB_3.364.csv and Subcluster_qscore_output_IL_PDB_3.364.csv. For hairpin loops, the output files are Subcluster_output_HL_PDB_3.364.csv and Subcluster_qscore_output_HL_PDB_3.364.csv. Commands to run GINClus for NRList release 3.364 is given below:
