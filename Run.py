...
def main():
    ...
    parser.add_argument('-ul', nargs='?', default='graphs_dir/IL_Graph_Data/', const='graphs_dir/IL_Graph_Data/', help="Path to the graph data generated for unknown motifs. Default: 'graphs_dir/IL_Graph_Data/'.")
